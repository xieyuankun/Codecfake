...
if __name__ == "__main__":
    ...
    print(summary(W2VAASIST(), torch.randn((16,1,1024,201)), show_input=False))
    #lfcc = torch.randn(1, 1, 60, 750)
    #res2net = se_res2net50_v1b(pretrained=False, num_classes=2)
    #feat, out = res2net(lfcc)
    #print(feat.shape)
    #print(out.shape)
    #W2VAASIST = W2VAASIST().cuda()
    #feature = torch.randn((16,1,1024,201)).cuda()
    #output = W2VAASIST(feature)
